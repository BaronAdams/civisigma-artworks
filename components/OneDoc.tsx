...
const OneDoc = () => {
  return (
    <Tailwind>
      <div>
        <div className="bg-gradient-to-r from-blue-600 to-blue-400 -z-10 absolute -left-[2cm] right-[25%] -skew-y-12 h-[100%] bottom-[95%]"></div>
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 -z-20 absolute left-[75%] -right-[2cm] -skew-y-12 h-[100%] bottom-[90%]"></div>
        <div className="bg-slate-100 -rotate-12 -z-10 absolute -left-[200em] -right-[200em] h-[100%] top-[75%]" />
        <main className="text-slate-800 pt-24 h-[90%] flex flex-col">
          <svg
            version="1.1"
            id="Layer_1"
          ...
          <div className="p-12 flex-grow bg-white rounded-2xl rounded-t-none shadow-xl shadow-black/10">
            ...
            fake company and this is a fake receipt. This is just a demo to show you
            how you can create a beautiful receipt with Onedoc.{" "}
            <Footnote>
